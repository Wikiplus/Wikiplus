            ...
            _createClass(Wikiplus, [{
                ...
                value: function initQuickEdit() {
                    ...
                    if (mw.config.get('skin') === 'minerva') {
                        ...
                        $(topBtn).find('a').css('vertical-align', 'middle');
                        $(topBtn).find('a').addClass('mw-ui-icon mw-ui-icon-element mw-ui-icon-wikimedia-edit-base20 mw-ui-icon-with-label-desktop');
                    }
